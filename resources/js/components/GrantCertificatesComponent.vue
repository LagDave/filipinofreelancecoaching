                ...
                >
                    <div class="row">
                        <div class="col-8">
                            ...
                            >
                                <small>@{{ certificate.user.username }}</small>
                            </p>
                        </div>
                        <div class="col-4">
                            <button
                                @click="toggleGrantCertificate(certificate.id)"
                    ...
                    <div class="collapse" :id="'collapse_' + certificate.id">
                        <div class="card card-body px-1 py-1">
                            <p class="mb-1">
                                <small
                                    >Email:
                                    <b>{{ certificate.user.email }}</b></small
                                >
                            </p>
                            <p class="mb-1">
                                <small>
