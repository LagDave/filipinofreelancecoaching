...
<head>
  ...
  <link href="{{asset('homepage/assets/vendor/venobox/venobox.css')}}" rel="stylesheet">
...
<body>
  ...
  <!-- ======= Hero Section ======= -->
  <section id="hero" class="d-flex align-items-center shadow">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="fade-left" data-aos-delay="200">
          <img src="{{asset('homepage/assets/img/hero-image.jpg')}}" class="img-fluid animated" alt="">
        </div>
      </div>
    </div>
  ...
  <main id="main">
      ...
      <div class="container">
        ...
        <div class="row content">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0" data-aos="fade-up" data-aos-delay="300">
            ...
            <a href="#" class="btn-learn-more">Enroll Now</a>
          </div>
        </div>
    ...
    <section id="services" class="services">
      <div class="container">
        ...
        <div class="section-title" data-aos="fade-up">
          <h2>Benefits</h2>
          <p>Every employer will not be able to resist your talent and skills once you have mastered our courses, templates, tools and softwares!</p>
        </div>
  ...
  <script src="{{asset('homepage/assets/vendor/waypoints/jquery.waypoints.min.js')}}"></script>
  <script src="{{asset('homepage/assets/vendor/counterup/counterup.min.js')}}"></script>
  ...
  <script src="{{asset('homepage/assets/vendor/venobox/venobox.min.js')}}"></script>
